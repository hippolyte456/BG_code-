...
class JobDispatcher:
  ...
  def load_cmdline_config(self, cmd_args):
    ...
    self.params.update({k: v for k, v in vars(cmd_args).items() if k in ['LG14modelID', 'whichTest', 'nbcpu', 'nbCh', 'email', 'nestSeed', 'pythonSeed', 'splitGPe', 'inputPop', 'simDuration'] if v != None})
